...
def try_methods_and_functions():
    ...
    hana = rg.SimpleTurtle()
    hana.pen = rg.Pen('blue', 5)

    hana.backward(150)
    hana.speed = 1

    draw_many_squares(hana, 2, 100, 30)
    hana.speed = 5
    hana.pen = rg.Pen('red', 5)

    draw_many_squares(hana, 10, 50, 15)
    hana.speed = 100
    hana.pen = rg.Pen('red', 35)

    draw_many_squares(hana, 8, 300, 60)
    hana.speed = 5
    hana.pen = rg.Pen('black', 3)
    hana.backward(200)
