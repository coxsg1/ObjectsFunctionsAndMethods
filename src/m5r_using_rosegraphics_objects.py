...
#                radius, center, outline_color
#
#     f. What does a RoseWindow RENDER method do?
#            Displays the called code.
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            When the purpose of the window has been completed so that the user can easily exit, necessary at the end.
#
