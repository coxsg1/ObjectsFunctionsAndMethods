...
def turtle5():
    ...
    anna.pen = rg.Pen('green', 10)

    first_point = rg.Point(anna.x_cor(), anna.y_cor())
    final_point = rg.Point(-50, -100)

    anna.pen_up()
    anna.go_to(final_point)
    anna.pen_down()
    ...
    anna.go_to(first_point)

    chad = rg.SimpleTurtle('turtle')
    chad.pen = rg.Pen('pink', 12)
